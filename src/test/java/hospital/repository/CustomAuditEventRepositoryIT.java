...
import hospital.config.audit.AuditEventConverter;
import hospital.domain.PersistentAuditEvent;
...
import static hospital.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
